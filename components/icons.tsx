...
export const BloombergIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      height={size}
      style={{ color: "currentcolor" }}
    ...
    >
      <path
        d="M0 5.468h4.396c2.758 0 4.224 1.209 4.224 3.369 0 1.442-.857 2.507-2.17 2.88v.057c1.628.286 2.65 1.466 2.65 3.14 0 2.362-1.637 3.618-4.512 3.618H0V5.468zm4.11 5.507c1.409 0 2.14-.63 2.14-1.724 0-1.065-.731-1.666-2.14-1.666H2.51v3.39h1.6zm.229 5.908c1.58 0 2.426-.687 2.426-1.924 0-1.237-.846-1.924-2.426-1.924H2.51v3.848h1.83z"
        fill="currentColor"
      />
      <path
        d="M10.532 5.468h2.51v13.064h-2.51V5.468z"
        fill="currentColor"
      />
      <path
        d="M14.756 12.964c0-3.418 2.197-5.693 5.357-5.693 3.16 0 5.357 2.275 5.357 5.693s-2.197 5.693-5.357 5.693c-3.16 0-5.357-2.275-5.357-5.693zm8.203 0c0-2.19-1.151-3.533-2.846-3.533-1.694 0-2.845 1.342-2.845 3.533s1.151 3.533 2.845 3.533c1.695 0 2.846-1.342 2.846-3.533z"
        fill="currentColor"
      />
    </svg>
  );
